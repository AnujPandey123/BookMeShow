    ...
    render(){
        ...
        return( 
           ...
           < input type = 'tel'
            ...
            <p className = 'hdng' > Date </p> <p className='hdng'> Location </p >
            <p className = 'hdng' > Movie </p> <hr className='hr3' />
            <p className = 'hdng' > Name </p>{' '} { this.renderNamesOfPassenger() } < hr className = 'hr3' / >
